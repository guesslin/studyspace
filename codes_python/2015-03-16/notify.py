...
class AsyncNotify():
    ...
    Refer to the documentation for more information on LISTEN, NOTIFY and
    UNLISTEN. http://www.postgresql.org/docs/8.3/static/sql-notify.html
    This obscure feature is very useful. You can create a trigger function on a
    table that executes the NOTIFY command.
    Then any time something is inserted, updated or deleted your Python
    function will be called using this class.
    As far as I know this is unique to PostgreSQL.
    I have no use for any other server :-)'''
    ...
    def gotnotify(self, pid, notify):
        ...
        Unless you override this method and do someting
        this whole thing is rather pointless.'''
        pass
